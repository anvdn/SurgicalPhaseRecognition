...
if __name__ == '__main__':
    ...
    model_parameters = (args.model_name, utils.num_classes, True, 20

    # load model
    model = models.MobileNetStage(*model_parameters).to(utils.device)

    # create pytorch datasets
    datasets = {x: utils.HerniaDataset(utils.dfs_path + '/' + x + '_no_temp.pkl', is_stage_feature = True, num_stages = 20,
